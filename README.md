...
Como usar:
 No terminal escreva:
  *baixe todos os arquivos do github<br>
  *escolha uma imagem(mudando o nome no VariaveisGlobais.java)<br>
  *rode o Main<br>
...
como funciona:
 ...
 5º- Essa matriz é transformada em um grafo<br>
 6º- Grafo passa pelo algoritmo Djikstra, vendo o menor caminho em quantia de pixeis<br>
 7º- Abre uma tela Jpanel<br>
